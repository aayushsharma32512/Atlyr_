...
export const DESC_MODEL = 'gemini-2.0-flash'
export const IMG_MODEL = 'gemini-2.5-flash-image-preview'

export const LIKENESS_STAGE1_MODEL = 'gemini-3-pro-preview'
...
export const TRYON_STAGE1_MODEL = 'gemini-3-pro-preview'
