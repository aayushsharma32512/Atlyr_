-- Drop previous versions to ensure clean update
...
-- 1. Text Match with Filters (Regex Match for CSV fields)
...
BEGIN
  ...
  WHERE p.text_vector IS NOT NULL
    ...
    -- Looks for the filter string surrounded by start/end or commas, ignoring whitespace
    AND (
...
-- 2. Image Match with Filters (Regex Match for CSV fields)
