  ...
  async execute(job: IngestionPipelineJob): Promise<void> {
    ...
    await saveArtifact({
      ...
      data: {
        ...
        route_used:       summary.route_used,
        attempted:        summary.attempted.length ? summary.attempted : null,
    ...
    try {
      ...
      await saveArtifact({
        ...
        data: {
          ...
          route_used:              enrichment.route_used,
          attempted:               enrichment.attempted.length ? enrichment.attempted : null,
