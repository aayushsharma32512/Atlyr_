...
import { clearStudioLastPaths } from '@/features/studio/constants';

interface AuthContextType {
  user: User | null;
  session: Session | null;
  loading: boolean;
  signUp: (email: string, password: string, emailRedirectTo?: string) => Promise<{ error: AuthError | null }>;
