...
/**
 * First run, step 1 of 2 — who you are. Name, photo, age, height, figure and
 * size in one pass; everything but the photo is required. Name and photo
 * prefill from Google sign-in when present; Google does not share age or gender.
 */
export function OnboardingAboutPage() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      navigate(ONBOARDING_FIGURE_PATH)
    } catch (error) {
...
export default OnboardingAboutPage
