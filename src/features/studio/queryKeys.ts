...
export const studioKeys = {
  ...
  wardrobeAlternatives: (args: { slot: string | null | undefined; productIds: string[]; outfitIds: string[] }) =>
    [...studioKeys.all, "wardrobe-alternatives", args.slot ?? "none", args.productIds, args.outfitIds] as const,
  productOutfits: (
